...
class AutoEncoder(Dictionary, nn.Module):
    ...
    def __init__(self, activation_dim, dict_size, device, dtype):
        super().__init__()
        self.activation_dim = activation_dim
        self.dict_size = dict_size
        self.bias = nn.Parameter(t.zeros(activation_dim, device=device, dtype=dtype))
        self.encoder = nn.Linear(activation_dim, dict_size, bias=True, device=device, dtype=dtype)

...
class MiscMetrics(BaseMetrics):
    ...
    average_max_encoder_cosine_sim_alive: float = Field(
        title="Average Max Encoder Cosine Similarity (Alive)",
        description="Average of the maximum cosine similarity with any other alive feature's encoder weights",
    )
    average_max_decoder_cosine_sim_alive: float = Field(
        title="Average Max Decoder Cosine Similarity (Alive)",
        description="Average of the maximum cosine similarity with any other alive feature's decoder weights",
    )
...
class CoreFeatureMetric(BaseResultDetail):
    ...
    max_decoder_cosine_sim_alive: float = Field(
        title="Max Decoder Cosine Similarity (Alive)",
        description="Maximum cosine similarity with any other alive feature's decoder weights",
    )
    max_encoder_cosine_sim_alive: float = Field(
        title="Max Encoder Cosine Similarity (Alive)",
        description="Maximum cosine similarity with any other alive feature's encoder weights",
    )

...
class RAVELInstance:
    ...
    def __init__(self):
        ...
        self.entity_splits = {}
        self.attribute_type_to_templates = {}
        self.config = {}
    ...
    def create_from_files(
        ...
        instance.initialize_config(entity_type, model_name, downsample, config.context_length)
    ...
    def initialize_config(
        self, entity_type: str, model_name: str, downsample: int | None = None, context_length: int = 1024
    ):
    ...
    def build_and_tokenize_prompts(
        ...
        """
        context_length = self.config.get("context_length", 1024)
        for entity_label in tqdm(
            ...
            for attribute_type, templates in self.attribute_type_to_templates.items():
                ...
                for template in templates:
                    ...
                    encoded = tokenizer.encode(text, truncation=True, max_length=context_length)
                    if isinstance(
                        encoded[0], list
                    ):
                        raise ValueError(
